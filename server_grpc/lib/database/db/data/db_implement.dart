...
class DbImplement extends DbTableRepo {
 ...
 Future<List<Map<String,dynamic>>> customQuery(String query) async => await DbServices.customQuery(query);
  ...
  @override
  Future<bool> cleanTable(NameTable table)async => await DbServices.cleanResult(table);
  
  @override
  Future<List<Map<String, dynamic>>> getBy(NameTable table, {required SearchBy type, required String value}) async => await DbServices.getBy(table, idSear: type, id: value);
